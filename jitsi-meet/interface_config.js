...
var interfaceConfig = {
    ...
    // The "VKS TV" logo and its link are removed from the UI:
    // SHOW_JITSI_WATERMARK below hides the watermark everywhere, so this link
    // is no longer rendered. Previous values: 'https://a.slamx.ru',
    // 'http://localhost:5173'.
